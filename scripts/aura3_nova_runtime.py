...
Implements the same governed roles as the DeepSeek path: strict image validation,
image-grounded copy generation, business/conversion gate, and caption-image semantic gate.
Founder approval and publishing authority are unchanged.
"""
...
def preflight(_unused_key: str = "") -> set[str]:
    ...
    # A tiny text request proves the configured model is invokable without exposing credentials.
