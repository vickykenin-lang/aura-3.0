...
def main():
    ...
    checks += [
        check(contract.get("department_id") == "aura3" and contract.get("authority", {}).get("supreme") == "Founder", "constitutional_contract", "AURA3 is Founder-governed and standalone"),
